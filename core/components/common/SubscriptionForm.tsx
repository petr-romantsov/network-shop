...
export const SubscriptionForm = () => {
  ...
  return (
    <form className="mt-auto" onSubmit={handleSubmit}>
      <Container className="flex flex-col items-center justify-center gap-[17px] p-6 md:py-[70px] md:px-0 bg-black h-[266px] md:h-[290px]">
        {isSuccess ? (
          ...
          <>
            ...
            <div className="flex flex-col items-center md:items-start gap-[17px]">
              ...
              <p className="text-white text-sm text-center md:text-start font-normal leading-[120%]">
                ...
                <UiLink href="/privacy-policy" color="white">
